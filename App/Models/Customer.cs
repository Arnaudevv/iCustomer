...
namespace iCustomer.Models
{
    public class Customer : INotifyPropertyChanged
    {
        ...
        // Generated at runtime using seasonal weights — NOT persisted to XML.
        // The chart view reads this property; the repository ignores it.
        ...
        /// <summary>
        /// Standard constructor used when creating a new customer in the UI.
        /// Monthly expenses are generated randomly.
        /// </summary>
        ...
        // Picks a random base spend (500–5000 €) and scales by each
        // month's seasonal weight to produce 12 realistic monthly values.
        private static double[] GenerateMonthlyExpenses()
        {
            double baseMonthly = 500 + _rng.NextDouble() * 4_500;

            var expenses = new double[12];
            for (int i = 0; i < 12; i++)
                expenses[i] = Math.Round(baseMonthly * SeasonalWeights[i], 2);
